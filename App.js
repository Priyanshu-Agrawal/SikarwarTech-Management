  ...
  return (
    <>
        ...
        <Stack.Navigator screenOptions={
            ...
            <Stack.Screen name="Dashboard" component={Dashboard} options={{ headerShown: false, statusBarTranslucent: true }}/>
            <Stack.Screen name={"ViewEmployees"} component={ViewEmployees} options={{title: 'View Employees', statusBarTranslucent: true}}/>
            <Stack.Screen name="ManagePackage" component={ManagePackage} options={{title: 'Manage Package',statusBarTranslucent: true}}/>
        </Stack.Navigator>
        </NavigationContainer>
    </>
  );
